...
export default function ProjectCard({
  ...
  const CardContent = () => (
    <div className="group relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-white/30 overflow-hidden hover:scale-105 h-full flex flex-col">
